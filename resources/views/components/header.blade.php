...
<header class="tg-header__style-two">
    <div class="tg-header__inner-wrap">
        <div class="tg-header__logo-wrap">
            <div class="logo">
                <a href="index.html"><img src="{{url('assets/img/blue.png')}}" alt="Logo" /></a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tg-header__top-info tg-header__top-info-two list-wrap">
                            <li><i class="flaticon-phone-call"></i><a href="tel:0123456789">+255779351586</a></li>
                            <li><i class="flaticon-pin"></i>Dar es salaam, Tanzania</li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <ul class="tg-header__top-right tg-header__top-right-two list-wrap">
                            <li><i class="flaticon-envelope"></i><a href="mailto:info@growthhub.co.tz">info@growthhub.co.tz</a></li>
                        ...
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                <div class="logo d-none">
                                    <a href="{{url('/')}}"><img src="{{asset('assets/img/blue.png')}}" alt="Logo" /></a>
                                </div>
                                ...
                                <div class="tgmenu__action tgmenu__action-two d-none d-md-block">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-btn">
                                            <div class="dark-light-switcher d-flex justify-content-center align-items-center rounded-3">
                                        ...
                                        <li class="header-btn">
                                            <a href="contact.html" class="btn"><i class="far fa-comment-alt"></i>Get In Touch</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <nav class="tgmobile__menu-box">
                                ...
                                <div class="tgmobile__menu-bottom">
                                    <div class="contact-info">
                                        <ul class="list-wrap">
                                            <li><a href="mailto:info@apexa.com">info@growthhub.co.tz</a></li>
                                            <li><a href="tel:0123456789">0779351586</a></li>
                                        </ul>
                                    </div>
    ...
    <div class="offCanvas__info">
        ...
        <div class="offCanvas__logo mb-30">
            <a href="{{url('/')}}"><img src="{{url('assets/img/blue.png')}}" alt="Logo" /></a>
        </div>
